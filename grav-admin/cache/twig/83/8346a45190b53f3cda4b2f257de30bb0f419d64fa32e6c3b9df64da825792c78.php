...
class __TwigTemplate_c070554afc91b059fca5a6bae21943e5a75272681ca2d184b488c8e2e890dca3 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        if ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->authorize(array(0 => "admin.maintenance", 1 => "admin.super"))) {
            // line 2
            echo "    ";
            $context["backup"] = $this->getAttribute(($context["admin"] ?? null), "lastBackup", array(), "method");
            // line 3
            echo "
    <div id=\"updates\" class=\"dashboard-item dashboard-left\">
        <div class=\"secondary-accent default-box-shadow\">
            ...
            // line 15
            echo twig_escape_filter($this->env, twig_jsonencode_filter(array("series" => array(0 => $this->getAttribute(($context["backup"] ?? null), "chart_fill", array()), 1 => $this->getAttribute(($context["backup"] ?? null), "chart_empty", array())))), "html_attr");
            echo "\">
                    <div class=\"chart-wrapper\">
                        <div class=\"ct-chart chart-loader\"><i class=\"fa fa-refresh fa-spin\"></i></div>
                        <span class=\"numeric hidden\">";
            // line 18
            echo $this->getAttribute(($context["backup"] ?? null), "days", array());
            echo "<em>";
            ...
            echo "</a>
                <button data-ajax=\"";
            // line 26
            echo twig_escape_filter($this->env, $this->getAttribute(($context["uri"] ?? null), "addNonce", array(0 => (((($context["base_url_relative"] ?? null) . "/backup.json/task") . $this->getAttribute($this->getAttribute(($context["config"] ?? null), "system", array()), "param_sep", array())) . "backup"), 1 => "admin-form", 2 => "admin-nonce"), "method"), "html", null, true);
...
{% endif %}
", "partials/dashboard-maintenance.html.twig", "/Applications/MAMP/htdocs/mye2o/grav-admin/user/plugins/admin/themes/grav/templates/partials/dashboard-maintenance.html.twig");
    }
}
