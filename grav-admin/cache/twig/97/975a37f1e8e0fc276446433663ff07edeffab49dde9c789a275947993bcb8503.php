...
class __TwigTemplate_8b53e8b67d2b7acda34b087bcc32f297b1c5c80ea39559ec8de643879b61697e extends Twig_Template
{
    ...
    public function block_input($context, array $blocks = array())
    {
        ...
        try {            // line 6
            ...
            ";
            // line 8
            $context["secret"] = (($this->getAttribute(($context["user"] ?? null), "twofa_secret", array())) ? ($this->getAttribute(($context["user"] ?? null), "twofa_secret", array())) : ($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "login", array()), "twoFactorAuth", array()), "createSecret", array(), "method")));
            // line 9
            echo "            ";
            $context["image"] = $this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "login", array()), "twoFactorAuth", array()), "getQrImageData", array(0 => $this->getAttribute(($context["user"] ?? null), "username", array()), 1 => ($context["secret"] ?? null)), "method");
            // line 10
            echo "
        ...
        ";
            ...
            echo "            <div class=\"notice error\">
                <p>";
            // line 24
            echo twig_escape_filter($this->env, $this->getAttribute(($context["e"] ?? null), "message", array()), "html", null, true);
            echo "</p>
            </div>
        ";
        }
...
{% endblock %}
", "forms/fields/2fa_secret/2fa_secret.html.twig", "/Applications/MAMP/htdocs/mye2o/grav-admin/user/plugins/login/templates/forms/fields/2fa_secret/2fa_secret.html.twig");
    }
}
