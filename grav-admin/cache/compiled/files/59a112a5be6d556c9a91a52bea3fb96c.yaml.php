...
return [
    ...
    'filename' => '/Users/gabrielescano/Documents/FactoriaF5/mye2o/grav-admin/user/plugins/admin/languages/zh.yaml',
    'modified' => 1538386604,
    'data' => [
        'PLUGIN_ADMIN' => [
            ...
            'NEEDS_GRAV_1_1' => '<i class="fa fa-exclamation-triangle"></i> <strong>你正在運行Grav v%s</strong>。你必須更新到最新的 <strong>Grav v1.1.x</strong> 版本，以確保相容性。這可能需要切換到 <strong>測試 GPM 發布</strong> 系統組態中。',
